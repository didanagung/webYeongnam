...
const Kontak = () => {
  return (
    <div className="p-5 text-center" id="kontak">
      ...
      <section>
        <ul className="grid grid-cols-1 gap-2 md:grid-cols-3 w-10/12 m-auto my-7">
          <li className="w-full bg-white rounded-xl shadow-xl p-4 group hover:cursor-pointer hover:bg-teal-800">
            {/* <HiLocationMarker className="w-14 h-14 md:w-20 md:h-20 m-auto my-2 group-hover:text-white" /> */}
            ...
            <p className="font-semibold group-hover:text-white">
              Jalan AMD Dusun Tarikolot Kecamatan Pamulihan Kabupaten Sumedang
              Provinsi Jawa Barat
            </p>
          </li>
          <li className="w-full bg-white rounded-xl shadow-xl p-4 group hover:cursor-pointer hover:bg-teal-800">
            {/* <BiPhoneCall className="w-20 h-20 m-auto my-2 group-hover:text-white" /> */}
            <a
